 ...
 */
class XPSoapClient extends \lang\Object implements ISoapClient, Traceable {
  protected
    $transport          = null,
  ...
  public function __set($key, $value) {
    throw new \lang\IllegalAccessException('Direct modification of member "'.$key.'" is no longer supported.');
  }
  ...
  public function setStyle($style) {
    switch ($style) {
      ...
      default:
        throw new \lang\IllegalArgumentException('XPSoapClient does not support given soap style');
    }
  }
  ...
  public function setSoapEncoding($encoding) {
    switch ($encoding) {
      ...
      default:
        throw new \lang\IllegalArgumentException('XPSoapClient does not support given soap encoding');
    }
  }
  ...
  public function setSoapVersion($version) {
    switch ($version) {
      ...
      default:
        throw new \lang\IllegalArgumentException('XPSoapClient does not support given soap version');
    }
  }    
  ...
  public function invoke() {
    if (!$this->transport instanceof SOAPHTTPTransport) throw new \lang\IllegalArgumentException(
